...
class QRCodeGenerator:
    ...
    def generate_qr_code(
        ...
        try:
            ...
            logger.info(
                f"Generated QR code for assignment: {metadata.assignment_id}")
            return qr_img
...
def demo_qr_generation():
        ...
        Args:
            metadata: AssignmentMetadata object, dict, string, or any object
        ...
        try:
            ...
            if hasattr(self, 'generate_qr_code'):
                ...
                try:
                    ...
                    print(f"✅ Generated QR image: {qr_image.size}")
                    return qr_image
                except ImportError:
